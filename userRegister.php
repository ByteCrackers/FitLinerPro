...
<div class="flex flex-col justify-center min-h-full px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <form class="space-y-6" method="POST" action="./controllers/AuthController.php">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Register</button>
      </div>
    </form>

    <p class="mt-10 text-sm text-center text-gray-500">
      Already have an account?
      <a href="../index.php" class="font-semibold leading-6 text-orange-600 hover:text-orange-400">Sign in</a>
    </p>
  </div>
</div>
</body>
