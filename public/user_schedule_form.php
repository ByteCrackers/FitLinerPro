...
<body>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-14">
        <a href="user_dashboard.php"><button> <img src="../assets/images/Icon/back.png" alt=""></button></a> 
        <br>
        <br>
            <!-- Schedule Form -->
            <form method="POST" action="">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="exercise" name="exercise" value="<?php echo htmlspecialchars($exercise); ?>" disabled class="block w-full p-2 border border-gray-300 rounded-md">
                </div>

                <div class="mb-5">
                    <label for="reps" class="block mb-2 text-sm font-medium text-gray-900">Reps</label>
                    <input type="number" id="reps" name="reps" value="<?php echo htmlspecialchars($reps); ?>" disabled class="block w-full p-2 border border-gray-300 rounded-md">
                </div>

                <div class="mb-5">
                    <label for="sets" class="block mb-2 text-sm font-medium text-gray-900">Sets</label>
                    <input type="number" id="sets" name="sets" value="<?php echo htmlspecialchars($sets); ?>" disabled class="block w-full p-2 border border-gray-300 rounded-md">
                </div>

                <div class="mb-5">
                    <label for="month" class="block mb-2 text-sm font-medium text-gray-900">Month</label>
                    <input type="text" id="month" name="month" value="<?php echo htmlspecialchars($month); ?>" disabled class="block w-full p-2 border border-gray-300 rounded-md">
                </div>

                <div class="mb-5">
                    <label for="added_by" class="block mb-2 text-sm font-medium text-gray-900">Added by</label>
                    <input type="text" id="added_by" name="added_by" value="<?php echo htmlspecialchars($added_by); ?>" disabled class="block w-full p-2 border border-gray-300 rounded-md">
                </div>
